// src/services/conditionChecker.js
...
const checkConditions = (device, payload) => {
    ...
    device.conditions.forEach((cond) => {
        ...
        const currentValue = payload[condType];
        ...
        if (isTriggered) {
            triggered.push({
                ...
                message: `${condType} is ${cond.operator} ${cond.value}`,
            });
